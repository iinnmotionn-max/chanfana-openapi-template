...
tests/integration/     28 suites, 210 tests: seed→trade→learn→evolve; audit→
                       sweep→check-in; aether, wallet, defi, shield, growth(x),
                       buildplan, freshness, rp, local, orchestrator, command,
                       autonomy, authority-posture, ratelimit, rotation, appintegrity, callers, creator, policy, readiness, sources, dash, automation, hotpath
```
